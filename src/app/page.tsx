...
export default function Home() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : dict.home.somethingWentWrong
      );
    } finally {
      setSubmitting(false);
    }
        ...
        <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-6">
          <section className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900 sm:p-5">
            ...
            <input
              ...
              placeholder={dict.home.tripNamePlaceholder}
                ...
                >
                  <div className="flex w-full flex-col gap-1.5">
                    <input
                      ...
                      placeholder={t(dict.home.personPlaceholder, {
                        n: idx + 1,
                      })}
                    ...
                    <input
                      ...
                      placeholder={dict.home.paymentInfoPlaceholder}
                  ...
                  <button
                    ...
                    aria-label={dict.home.removePerson}
                  >
                    ✕
                  </button>
                </div>
          ...
          >
            {submitting ? dict.home.creating : dict.home.createTrip}
          </button>
        </form>
      </main>
    </div>
